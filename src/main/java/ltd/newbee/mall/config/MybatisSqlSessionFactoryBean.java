...
public class MybatisSqlSessionFactoryBean implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent> {
    private static final Logger LOGGER = LoggerFactory.getLogger(com.baomidou.mybatisplus.extension.spring.MybatisSqlSessionFactoryBean.class);
    ...
    protected SqlSessionFactory buildSqlSessionFactory() throws Exception {
        ...
        targetConfiguration.setEnvironment(new Environment(com.baomidou.mybatisplus.extension.spring.MybatisSqlSessionFactoryBean.class.getSimpleName(),
